...
public class UtGen {
    ...
    public static String enviar="", ia="";
    ...
    public static void emitirComentario(String c) throws FileNotFoundException, IOException {
        if (debug) {
           // System.out.println("*      "+c);
            enviar="*      "+c+nuevalinea;
            emitirArchivo(enviar);
     ...
     */
    public static void emitirRO(String op, int r, int s, int t, String c) throws FileNotFoundException, IOException {
       enviar=(instruccionActual++)+":       " + op + "       " + r + "," + s + "," + t;
     ...
     * c = comentario a emitir en modo debug
     */
    public static void emitirRM(String op, int r, int d, int s, String c) throws FileNotFoundException, IOException {
       
       
        enviar=(instruccionActual++)+ ":       " + op + "       " + r + "," + d + "(" + s + ")";
    ...
    public static void cargarRespaldo(int direccion) throws FileNotFoundException, IOException {
     ...
     * c = comentario a emitir en modo debug
     */
    public static void emitirRM_Abs(String op, int r, int a, String c) throws FileNotFoundException, IOException {
      
        enviar=(instruccionActual)+":       "+op+"       "+r+","+(a - (instruccionActual + 1))+"(" + PC + ")";
        emitirArchivo(enviar);
         // System.out.print((instruccionActual) + ":       " + op + "       " + r + "," + (a - (instruccionActual + 1)) + "(" + PC + ")");
        ++instruccionActual;
        if (debug) {
           // System.out.println("      " + c);
            emitirArchivo("      " + c+nuevalinea);
    ...
    public static void emitirArchivo(String guardar) throws FileNotFoundException, IOException{
    fw=new FileWriter("src/ejemplo_generado/prueba.tm",true);
    if(true){
    fw.write(guardar);
